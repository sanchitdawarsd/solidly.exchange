      ...
      <div className={ classes.fieldsContainer }>
        ...
        <Grid container spacing={3} className={classes.testColor}>
          <Grid item lg={12} md={12} sm={12} xs={12}>
            <Typography variant="h1" className={classes.welcomeTitle}>Welcome to <span className={classes.blueTxt}>Solid Swap</span></Typography>
            <Typography variant="body2" className={classes.welcomeSubtitle}>
              Supply Collateral to Borrow Iron Bank Assets. Solid Swap provides an alternative to USD denominated stable coins. It allows liquidity providers exposure to currencies such as EUR, KRW, GBP, CHF, AUD, and JPY.
            </Typography>
            <Button
