  ...
  return (
    <>
      <Typography className={classes.abouttext} gutterBottom>
        Solid Swap is designed to be an immutable, 0 fee, 0 governance, decentralized stable coin framework.
      </Typography>
      <Typography className={classes.abouttext} gutterBottom>
...
const LinksPrimer = () => {
  return (
    <>
      <Typography className={classes.abouttext} gutterBottom>
        If you would like to read more on the Solid Swap, you can read Andre Cronje's <a href='https://andrecronje.medium.com/fair-launches-decentralized-collaboration-and-fixed-forex-ab327a2e4fc4' target='_blank'>Launch Medium Article</a>
      </Typography>
      <Typography className={classes.abouttext} gutterBottom>
        If you would like to get more involved, head over to the <a href="https://gov.yearn.finance/c/projects/fixed-forex/26" target="_blank">Yearn Forum</a> to discuss Solid Swap.
      </Typography>
      <Typography className={classes.abouttext} gutterBottom>
...
const ContractsPrimer = () => {
  return (
    <>
      ...
      <Typography className={classes.abouttext} gutterBottom>
        <a href="https://etherscan.io/address/0x7d254d9adc588126edaee52a1029278180a802e8#code" target="_blank">0x7d254d9adc588126edaee52a1029278180a802e8</a> - Solid Swap Faucet for "ibEUR / ETH SUSHISWAP LP"
      </Typography>
      <Typography className={classes.abouttext} gutterBottom>
        <a href="https://etherscan.io/address/0x83893c4a42f8654c2dd4ff7b4a7cd0e33ae8c859#code" target="_blank">0x83893c4a42f8654c2dd4ff7b4a7cd0e33ae8c859</a> - Solid Swap distribution contract
      </Typography>
    </>
  );
};
